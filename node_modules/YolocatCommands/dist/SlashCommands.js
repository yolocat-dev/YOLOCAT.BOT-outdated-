...
class SlashCommands {
    ...
    async create(name, description, options, guildId) {
        ...
        if (cmd) {
            ...
            if (cmd.description !== description ||
                ...
                optionsChanged) {
                console.log(`YolocatCommands > Updating${guildId ? ' guild' : ''} slash command "${name}"`);
        ...
        if (commands) {
            console.log(`YolocatCommands > Creating${guildId ? ' guild' : ''} slash command "${name}"`);
    ...
    async delete(commandId, guildId) {
        ...
        if (commands) {
            ...
            if (cmd) {
                console.log(`YolocatCommands > Deleting${guildId ? ' guild' : ''} slash command "${cmd.name}"`);
                cmd.delete();
            }
        }
        return Promise.resolve(undefined);
