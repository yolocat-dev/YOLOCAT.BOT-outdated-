...
export default class YolocatCommands extends EventEmitter {
  ...
  private async setUp(client: Client, options?: Options) {
    ...
    if (mongoUri) {
      ...
      if (showWarns) {
        console.warn(
          'YolocatCommands > No MongoDB connection URI provided. Some features might not work! See this for more details:\nhttps://docs.wornoffkeys.com/databases/mongodb'
        )
      }
    ...
    if (
      ...
      throw new Error(
        "YolocatCommands > The 'commands' directory must be an absolute path. This can be done by using the 'path' module. More info: https://docs.wornoffkeys.com/setup-and-options-object"
      )
    }
    ...
    if (
      ...
      throw new Error(
        "YolocatCommands > The 'features' directory must be an absolute path. This can be done by using the 'path' module. More info: https://docs.wornoffkeys.com/setup-and-options-object"
      )
    }
    ...
    console.log('YolocatCommands > Your bot is now running.')
  }

  public setMongoPath(mongoPath: string | undefined): YolocatCommands {
    console.warn(
      'YolocatCommands > .setMongoPath() no longer works as expected. Please pass in your mongo URI as a "mongoUri" property using the options object. For more information: https://docs.wornoffkeys.com/databases/mongodb'
    )
    return this
  }
  ...
  public setDisplayName(displayName: string): YolocatCommands {
  ...
  public setDefaultPrefix(defaultPrefix: string): YolocatCommands {
  ...
  public setPrefix(guild: Guild | null, prefix: string): YolocatCommands {
    if (guild) {
  ...
  public setColor(color: ColorResolvable | null): YolocatCommands {
    this._color = color
    return this
  }
  ...
  public setCategorySettings(category: ICategorySetting[]): YolocatCommands {
    for (let { emoji, name, hidden, customEmoji } of category) {
      ...
      if (this.isEmojiUsed(targetEmoji)) {
        console.warn(
          `YolocatCommands > The emoji "${targetEmoji}" for category "${name}" is already used.`
        )
      }
  ...
  public setTagPeople(tagPeople: boolean): YolocatCommands {
  ...
  public setBotOwner(botOwner: string | string[]): YolocatCommands {
    console.log(
      'YolocatCommands > setBotOwner() is deprecated. Please specify your bot owners in the object constructor instead. See https://docs.wornoffkeys.com/setup-and-options-object'
    )
  ...
  public setDefaultLanguage(defaultLanguage: string): YolocatCommands {
...
module.exports = YolocatCommands
