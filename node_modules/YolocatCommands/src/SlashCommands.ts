...
class SlashCommands {
  ...
  constructor(instance: YolocatCommands, listen: boolean, typeScript?: boolean) {
  ...
  public async delete(
    ...
    if (commands) {
      ...
      if (cmd) {
        console.log(
          `YolocatCommands > Deleting${guildId ? ' guild' : ''} slash command "${
            cmd.name
          }"`
        )
